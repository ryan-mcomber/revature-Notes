...
public class MultiThreadedCaculationChallenge {
	public static void main(String[] args) {
		try {
			BigInteger result = calculateResult(BigInteger.TEN,BigInteger.ONE,BigInteger.TEN,BigInteger.TWO);
	...
	public static BigInteger calculateResult(BigInteger base1, BigInteger power1, BigInteger base2, BigInteger power2) {
		 ...
		 */
		PowerCalculatingThread compThread = new PowerCalculatingThread(base1,power1);
		PowerCalculatingThread compThread2 = new PowerCalculatingThread(base2,power2);
		List<PowerCalculatingThread> threads = new ArrayList<>();
		threads.add(compThread);
		threads.add(compThread2);
