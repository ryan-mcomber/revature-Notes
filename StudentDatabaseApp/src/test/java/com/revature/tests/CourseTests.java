...
public class CourseTests {
	...
	// this is just a useless demo test
	@Test
	public void test() {
	...
	// CHALLENGE: Test setName()......and use the assertTrue JUnit Assertion
	// hint: google junit assertions....figure out how to use the assertTrue Assertion.
